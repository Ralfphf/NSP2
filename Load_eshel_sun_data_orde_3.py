...
class orde_3():
    def __init__(self):
        ...
        for i in range(len(self.wavelength_object)):
            if 6562.55 < self.wavelength_object[i] < 6564.15:
        ...
        for i in range(len(self.wavelength_object)):
            if 6562.55 < self.wavelength_object[i] < 6564.25:
        ...
        popt_n_A_H, self.pcov_n_A_H = curve_fit(normal_distribution, self.H_alpha_A_wavelength, H_alpha_A_intensity, p0=[1, 6562.7, 1], sigma=H_alpha_A_error)
        self.std_opt_A_H , self.avg_opt_A_H, self.c_opt_A_H= popt_n_A_H

        popt_n_B_H, self.pcov_n_B_H = curve_fit(normal_distribution, self.H_alpha_B_wavelength, H_alpha_B_intensity, p0=[1, 6562.7, 1], sigma=H_alpha_B_error)
        self.std_opt_B_H , self.avg_opt_B_H, self.c_opt_B_H= popt_n_B_H
    ...
    def residuals_graph(self):
        ...
        ax1.set_Citle("Wavelength calibration fit (x-pixels vs wavelength)")
    ...
    def fitted_spectrallines(self):
        plt.plot(self.wavelength_object, self.flux_object_norm_A, linewidth=1, label="Blauwverschoven absorptiespectrum")
        plt.plot(self.wavelength_object, self.flux_object_norm_B, linewidth=1, label="Roodverschoven absorptiespectrum")


        plt.plot(self.H_alpha_A_wavelength, (self.normal_distribution(self.H_alpha_A_wavelength, self.std_opt_A_H, self.avg_opt_A_H, self.c_opt_A_H)), label='Gaussische fitfunctie A')
        plt.plot(self.H_alpha_B_wavelength, (self.normal_distribution(self.H_alpha_B_wavelength, self.std_opt_B_H, self.avg_opt_B_H, self.c_opt_B_H)), label='Gaussische fitfunctie B')
        plt.plot(self.Ca_1_A_wavelength, (self.normal_distribution(self.Ca_1_A_wavelength, self.std_opt_A_C, self.avg_opt_A_C, self.c_opt_A_C)), label='Gaussische fitfunctie A')
        plt.plot(self.Ca_1_B_wavelength, (self.normal_distribution(self.Ca_1_B_wavelength, self.std_opt_B_C, self.avg_opt_B_C, self.c_opt_B_C)), label='Gaussische fitfunctie B')
        plt.plot(self.Ti_1_A_wavelength, (self.normal_distribution(self.Ti_1_A_wavelength, self.std_opt_A_T, self.avg_opt_A_T, self.c_opt_A_T)), label='Gaussische fitfunctie A')
        plt.plot(self.Ti_1_B_wavelength, (self.normal_distribution(self.Ti_1_B_wavelength, self.std_opt_B_T, self.avg_opt_B_T, self.c_opt_B_T)), label='Gaussische fitfunctie A')
        


        plt.plot(self.Ca_1_A_wavelength, (self.normal_distribution(self.Ca_1_A_wavelength, self.std_opt_A_C, self.avg_opt_A_C, self.c_opt_A_C)))
        plt.plot(self.Ca_1_B_wavelength, (self.normal_distribution(self.Ca_1_B_wavelength, self.std_opt_B_C, self.avg_opt_B_C, self.c_opt_B_C)))
        plt.plot(self.Ti_1_A_wavelength, (self.normal_distribution(self.Ti_1_A_wavelength, self.std_opt_A_T, self.avg_opt_A_T, self.c_opt_A_T)))
        plt.plot(self.Ti_1_B_wavelength, (self.normal_distribution(self.Ti_1_B_wavelength, self.std_opt_B_T, self.avg_opt_B_T, self.c_opt_B_T)))
    ...
    def returns_H_alpha(self):
        return self.avg_opt_A_H, self.pcov_n_A_H[1][1]**(1/2), self.avg_opt_B_H, self.pcov_n_B_H[1][1]**(1/2)
