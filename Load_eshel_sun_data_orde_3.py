...
def orde_3():
    ...
    popt_p, pcov_p = curve_fit(second_orde_poly, H_alpha_A_wavelength, H_alpha_A_intensity, p0=[1, 2, 6562.7], sigma=H_alpha_A_error)
    ...
    global min_A_g, error_A_g, min_B_g, error_B_g
    min_A_g = avg_opt_A 
    error_A_g = pcov_n_A[2][2]**(1/2)

    min_B_g = avg_opt_B
    error_B_g = pcov_n_B[2][2]**(1/2)
    return min_A_g, error_A_g, min_B_g, error_B_g 
...
def omlooptijd_3(min_A_g, error_A_g, min_B_g, error_B_g):
...
def main():
    min_A_g, error_A_g, min_B_g, error_B_g = orde_3()
    return omlooptijd_3(min_A_g, error_A_g, min_B_g, error_B_g)
